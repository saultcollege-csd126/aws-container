...
# __generated__ by Terraform from "us-east-1_7b7iBGmoD/14ev5gqpioclkr7rbf02kg92ta"
...
# __generated__ by Terraform from "us-east-1_7b7iBGmoD"
resource "aws_cognito_user_pool" "xpix" {
  alias_attributes           = null
  auto_verified_attributes   = ["email"]
  deletion_protection        = "ACTIVE"
  mfa_configuration          = "OFF"
  name                       = "User pool - wd62gf"
