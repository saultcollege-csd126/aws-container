...
# __generated__ by Terraform from "us-east-1_afks661PG/5pj95crr3bdbb1nfs82587idf6"
resource "aws_cognito_user_pool_client" "xpix" {
  ...
  user_pool_id                                  = var.user_pool_name
  write_attributes                              = []
...
# __generated__ by Terraform from "us-east-1_afks661PG"
resource "aws_cognito_user_pool" "xpix" {
  alias_attributes           = null
  auto_verified_attributes   = ["email"]
  deletion_protection        = "ACTIVE"
  mfa_configuration          = "OFF"
  name                       = "User pool - gjszoq"
