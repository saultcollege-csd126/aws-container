...
# __generated__ by Terraform from "us-east-1_i2AnPG1Al/59fnc58qen1n34du3alap1jf44"
...
# __generated__ by Terraform from "us-east-1_i2AnPG1Al"
resource "aws_cognito_user_pool" "xpix" {
  alias_attributes           = null
  auto_verified_attributes   = ["email"]
  deletion_protection        = "ACTIVE"
  mfa_configuration          = "OFF"
  name                       = "User pool - 8urkms"
  region                     = "us-east-1"
