...
# Verfy that you can connect to AWS
aws sts get-caller-identity
# The above command should return your AWS account number and user ARN, like so:
# {
#     "UserId": "AROAZDT4DWVJXGX4FEMIB:user4703244=_Student_View__Bob_Smith",
#     "Account": "92389239712487",
